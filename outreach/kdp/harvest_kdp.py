...
DATA = Path(__file__).resolve().parents[1] / "kdp" / "data"
OUT = DATA / "kdp_contacts_raw.json"          # same file the builder reads
PROGRESS = DATA / "_kdp_harvest_progress.json"        # resumable cache: domain -> record
...
def main():
    ...
    ap.add_argument("--domains-file", default=str(DATA / "kdp_domains.txt"))
